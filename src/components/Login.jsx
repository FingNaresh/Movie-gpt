  ...
  return (
    <div>
       ...
       <div className=' absolute'>
        ...
        <form className='w-3/12 absolute p-12 bg-black my-36 mx-auto right-0 left-0 text-white rounded-lg bg-opactity-80 '>
        <h1 className='font-bold text-3xl py-4'>{isSignInForm  ? "Sign In": "Sign Up"}</h1>
         {!isSignInForm &&(
            <input type="text" placeholder='Username' className='p-4 my-4 w-full bg-gray-700'/>
          )}
